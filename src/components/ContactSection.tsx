        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-neutral text-sm">infonyaya.law@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-on-scroll fade-in-up delay-200">
            ...
            >
              ...
              <form className="spotlight-content p-8" onSubmit={handleSubmit}>
                <h3 className="text-2xl font-bold mb-6">Get in Touch</h3>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="col-span-2 md:col-span-1">
                    <label className="block text-sm text-neutral mb-2">Name</label>
                    <input
                      type="text"
                      required
                      value={name}
                ...
                <div className="mb-6">
                  <label className="block text-sm text-neutral mb-2">Message</label>
                  <textarea
                    rows={4}
                    required
                    value={message}
                ...
                {/* Status feedback */}
                {status === "success" && (
                  <div className="flex items-center gap-2 text-teal mb-4 text-sm font-medium">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-secondary to-teal hover:from-white hover:to-white hover:text-primary text-primary font-bold py-4 rounded-lg transition-all transform hover:-translate-y-1 shadow-lg shadow-teal/20 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 flex items-center justify-center gap-2"
                >
                  {status === "loading" ? (
                    <>
